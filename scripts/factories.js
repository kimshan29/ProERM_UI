...
mainApp.factory("Model", function(Constant) {
    ...
    dmr.kkf.data = function ()
    {
        ...
        this.tangible = new function (){ this.id = "" , this.name = "" },
        this.roe = 0,
        this.roi = 0,
        this.harga = 0,
        this.referensiHarga = "",
    ...
    dmr.identifikasi.data = function ()
    {
        this.sasaranStrategis = new function ()
        {
            ...
            {
                this.kategoriRisiko = "",
                this.subKategori = new function () { this.id = "", this.name = "" },
                this.risiko = new function () { this.id = "", this.name = "" },
                this.kejadian = "",
                this.tipeSumberRisiko = new function () { this.id = "", this.name = "" },
                this.sumberRisiko = new function () { this.id = "", this.name = "" },
                this.penyebab = new function () { this.id = "", this.name },
                this.areaDampak = ""
            }
        },
        this.sasaranOperasional = new function ()
        ...
        this.sasaranStrategis = function ()
        {
            ...
            this.risiko = new function ()
            {
                ...
                this.penyebab = new function ()
                {
                    ...
                    this.fungsiKontrol = new function () { this.dampak = false, this.kemungkinan = true, this.keduanya = false },
                    this.efektifitas = new function () { this.approach = "", this.deployment = "", this.learning = "", this.integration = "", this.nilai = "" },
                    this.peringkatDampak = new function () { this.id = "", this.name = "" },
                    this.peringkatKemungkinan1 = new function () { this.id = "", this.name = "" },
                    this.peringkatKemungkinan2 = new function () { this.id = "", this.name = "" },
                    this.relatifRisiko = "",
                    this.tingkatRisiko = "",
             ...
             this.penyebab = new function ()
                 {
                     ...
                     { this.id = "", this.langkahKerja = "", this.picLangkah = "", this.biayaValuta = new function () { this.id = "", this.name = "" }, this.biaya = "", this.targetMulai = "", this.targetSelesai = "" },
                     this.fungsiKontrol = new function () { this.dampak = false, this.kemungkinan = false, this.keduanya = false },
                     this.peringkatDampak = new function () { this.id = "", this.name = "" },
                     this.peringkatKemungkinan = new function () { this.id = "", this.name = "" },
                     this.peringkatKemungkinan2 = new function () { this.id = "", this.name = "" },
                     this.relatifRisiko = "",
                     this.tingkatRisiko = "",
                     this.keberterimaanRisiko = ""
    ...
    dmr.persetujuan.data = function ()
    {
        ...
        this.coaching = false,
        this.verifikator = new function () { this.id = "", this.name = "" },
        this.kadiv = new function () { this.id = "", this.nama = "" }
    }
