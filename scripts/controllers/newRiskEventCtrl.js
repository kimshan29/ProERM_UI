mainApp.controller("newRiskEventCtrl", function($scope, HttpRequest, $location, $cookies, $routeParams, Helper) {
    ...
    $scope.lanjutRiskEventClick = function () {
