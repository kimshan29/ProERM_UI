mainApp.controller("riskEventCtrl", function ($scope, $routeParams, $timeout, $cookies, $injector, $location, HttpRequest, Helper, Constant, Model) {
    var idKr = $routeParams.idRiskEvent;
    var currentUser = {};
