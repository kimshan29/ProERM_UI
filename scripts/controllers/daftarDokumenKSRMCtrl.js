mainApp.controller("daftarDokumenKSRMCtrl", function ($scope, $routeParams, $q, $cookies, Constant, HttpRequest, Model, Helper, FileHelper, DTOptionsBuilder, DTColumnBuilder) {
    ...
    $scope.renderData = function ()
    {
        ...
        var apiUrl = "/api/DaftarDokumenKSRM/" + $scope.currentUser.email + "/?tahun=" + $scope.filter.tahun;
