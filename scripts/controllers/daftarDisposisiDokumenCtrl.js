mainApp.controller("daftarDisposisiDokumenCtrl", function ($scope, $routeParams, $q, $cookies, Constant, HttpRequest, Model, Helper, FileHelper, DTOptionsBuilder, DTColumnBuilder) {
    ...
    $scope.renderData = function ()
    {
        ...
        var apiUrl = "/api/DispositionDocuments/" + $scope.currentUser.email + "/?tahun=" + $scope.filter.tahun;
